...
export const stays: Stay[] = [
  {
    ...
    beds: [
      ...
      { type: { ja: "シングルベッド", en: "Single bed", zhTW: "單人床" }, count: 4, size: "100cm × 200cm" },
      {
        ...
        size: "—",
        note: {
          ja: "大人7名以上でご利用の場合、和室にシングル敷布団をご用意します。6名以下で追加布団が必要な場合は事前にご相談ください。",
          en: "For 7 or more adults, single futon bedding is provided in the tatami room. For 6 or fewer guests needing extra bedding, please contact us in advance.",
          zhTW: "若入住成人達 7 名以上，將於和室準備單人被褥。6 名以下如需加床，請事先與我們聯繫。",
        },
      },
      {
    ...
    checkOut: "10:00",
    cleaningEntryNote: {
      ja: "チェックアウト後の荷物預かりはできません。早着時の手荷物預かりについては、運用が確定次第ご案内します。",
      en: "We are unable to store luggage after check-out. Guidance on early-arrival luggage storage will be provided once finalized.",
      zhTW: "退房後恕無法提供行李寄放服務。提早抵達時的行李寄放服務，將於流程確定後另行說明。",
    },
    cautions: [],
    images: [
  ...
  },
  {
    ...
    beds: [
      ...
      { type: { ja: "クイーンソファーベッド", en: "Queen sofa bed", zhTW: "特大雙人沙發床" }, count: 1, size: "170cm × 211cm" },
      {
        ...
        size: "100cm × 210cm",
        note: {
          ja: "大人6名以上のご利用時に敷布団を準備する条件について、6名を含むかどうかは確認中です（TODO）。",
          en: "TODO: it is not yet confirmed whether the “6 or more adults” threshold for providing futon bedding includes exactly 6 guests.",
          zhTW: "「入住成人 6 名以上」時提供被褥的條件是否含 6 名，目前尚待確認（TODO）。",
        },
      },
    ],
    amenities: [
    ...
    checkOut: "10:00",
    cleaningEntryNote: {
      ja: "10:15頃から清掃スタッフが入室します。チェックアウト後の荷物預かりはできません。",
      en: "Cleaning staff enter around 10:15 AM. Luggage storage after check-out is not available.",
      zhTW: "清潔人員約於 10:15 進入打掃。退房後恕無法提供行李寄放服務。",
    },
    cautions: [],
    images: [
  ...
  },
  {
    ...
    beds: [
      ...
      {
        type: { ja: "ソファーベッド", en: "Sofa bed", zhTW: "沙發床" },
        count: 1,
        size: "184cm × 210cm",
        note: {
          ja: "大人5名以上のご予約時に準備します。",
          en: "Provided when booking for 5 or more adults.",
          zhTW: "入住成人達 5 名以上時提供。",
        },
      },
    ],
    ...
    checkOut: "10:00",
    cleaningEntryNote: {
      ja: "10:15頃から清掃スタッフが入室します。チェックアウト後の荷物預かりはできません。配送業者からの荷物受け取りや、荷物の発送・集荷サービスも行っておりません。早着時の荷物預かりは、配送ではなくスタッフへの手渡しのみです。",
      en: "Cleaning staff enter around 10:15 AM. Luggage storage after check-out, courier receiving, and parcel shipping/pickup are not available. Early-arrival luggage can only be handed directly to staff, not delivered.",
      zhTW: "清潔人員約於 10:15 進入打掃。退房後恕無法提供行李寄放，亦不提供代收快遞或包裹寄送服務。提早抵達時的行李寄放，僅限親手交予工作人員，不提供配送方式。",
    },
    cautions: [
      {
        severity: "important",
